...
<aside class="documentation-aside-container">
    <div class="row">
        <div class="col-12 d-flex justify-content-center flex-column">
            <p class="col-12 aside-Contents-heading text-md-center  text-xl-start">
            ...
            <li class="aside-contents-items"><a href="padding.php" class="<?php if ($currentPage == "padding.php"){ echo " crt-page"; } ?>">Padding</a></li>
            ...
            <li class="aside-contents-items"><a href="textdecoration.php" class="<?php if ($currentPage == "textdecoration.php"){ echo " crt-page"; } ?>">Text Decorations</a></li>
...
<div class="offcanvas-lg offcanvas-start doc-left-menu d-lg-none" tabindex="-1" id="offcanvasResponsive" aria-labelledby="offcanvasResponsiveLabel">
    ...
    <div class="row " style="overflow:scroll;">
        <div class="col-12 d-flex justify-content-center flex-column align-items-center">
            <p class="col-12 aside-Contents-heading text-center">
                <i class="bi bi-book-half"></i>
                Contents
            </p>
            <ul>
