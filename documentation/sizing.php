...
<body>
  ...
  <div class="Doc-Container container-fluid ">
    <div class="row">
      <h1 class="doc-page-title">Sizing.</h1>
      <p class="m-1 fs-4">Utilities for controlling how a element's width should be resized.<br>
        use Sizing properties by adding our predefined classes .</p>
      <ul class="m-2">
        As such, the classes are named using the format:

        <li class="ms-4"><code>.width-{value}</code> for all type of devices.</li>
        <br>
      </ul>
      <ul>
        Where values are one of:

        <li class="ms-4"><code>.width-25</code>.</li>
        <li class="ms-4"><code>.width-50</code>.</li>
        <li class="ms-4"><code>.width-75</code>.</li>
        <li class="ms-4"><code>.width-100</code>.</li>
        <br>
      </ul>
